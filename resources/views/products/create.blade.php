...
<div class="mx-auto px-4 py-4 bg-gradient-to-b from-blue-50 to-white min-h-screen">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <h1 class="text-3xl font-bold mb-6 text-blue-800 text-center">Add New Product</h1>
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" class="w-full px-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200" value="{{ old('name') }}" required>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="purchase_price" id="purchase_price" step="0.01" class="w-full pl-8 pr-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200" value="{{ old('purchase_price') }}" required>
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2 text-gray-500">$</span>
                        <input type="number" name="sale_price" id="sale_price" step="0.01" class="w-full pl-8 pr-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200" value="{{ old('sale_price') }}" required>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="number" name="stock" id="stock" class="w-full px-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200" value="{{ old('stock') }}" required>
            </div>
            ...
            <div class="flex items-center justify-end mt-8">
                ...
                <button type="submit" class="bg-blue-600 text-white px-6 py-3 rounded-md shadow-md hover:bg-blue-700 transition duration-300 ease-in-out flex items-center">
                    <i class="bi bi-check-circle mr-2"></i> Save Product
                </button>
            </div>
        </form>
    </div>
